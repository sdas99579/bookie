...
<div style="clear:both"></div>
    <br />
    <h1 class="cantainer text-center"> My Order  <i class="fas fa-cart-arrow-down"></i></h1><br>
    ...
    <td><a href="myorder.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span  class="text-danger">Cancel Order</span><!-- </a><td> <a href="" class="text-danger"> Place Order </a> --> </td></td>
    </tr>
    <!-- <script type="" id="add">
              Swal.fire(
              'Congratulation!',
